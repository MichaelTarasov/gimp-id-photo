...
# Михаил Тарасов (редакция 2016 г.)
# mt@hta.by
...
class id_photo_base(object):
    ...
    formats = {
        'formats': [
            {'angle': False, 'category': 'pass', 'copys': 4, 'faceheight': 32, 'gray_frame': False, 'height': 45,
             'name': 'Паспорт РФ', 'onlyface': False, 'oval': False, 'overheadheight': 5, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'pass', 'copys': 4, 'faceheight': 34, 'gray_frame': False, 'height': 50,
             'name': 'Паспорт РБ', 'onlyface': False, 'oval': False, 'overheadheight': 3, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 40,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'pass', 'copys': 4, 'faceheight': 30, 'gray_frame': False, 'height': 47,
             'name': 'Загран. паспорт МИД', 'onlyface': False, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 36,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'pass', 'copys': 4, 'faceheight': 33, 'gray_frame': False, 'height': 45,
             'name': 'Загран. паспорт (биометрический)', 'onlyface': False, 'oval': True, 'overheadheight': 3, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': True, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 34, 'gray_frame': False, 'height': 45,
             'name': 'Виза Шенген', 'onlyface': False, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 18, 'gray_frame': False, 'height': 45,
             'name': 'Виза Англия', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 33, 'gray_frame': False, 'height': 45,
             'name': 'Виза Болгария', 'onlyface': False, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Германия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Голландия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Греция', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Испания', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Исландия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 40,
             'name': 'Виза Италия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 30,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 34, 'gray_frame': False, 'height': 45,
             'name': 'Виза Канада', 'onlyface': False, 'oval': False, 'overheadheight': 5, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Латвия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Литва', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 39, 'gray_frame': False, 'height': 45,
             'name': 'Виза ОАЭ', 'onlyface': False, 'oval': False, 'overheadheight': 3, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Польша', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Португалия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Словакия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Словения', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 2, 'faceheight': 30, 'gray_frame': False, 'height': 50,
             'name': 'Виза США', 'onlyface': False, 'oval': False, 'overheadheight': 3, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 50,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Финляндия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Франция', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Чехия', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'visa', 'copys': 4, 'faceheight': 13, 'gray_frame': False, 'height': 45,
             'name': 'Виза Швеция', 'onlyface': True, 'oval': False, 'overheadheight': 2, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'cert', 'copys': 4, 'faceheight': 12, 'gray_frame': False, 'height': 32,
             'name': 'Водительское', 'onlyface': False, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 25,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'cert', 'copys': 4, 'faceheight': 12, 'gray_frame': False, 'height': 34,
             'name': 'Пенсионное', 'onlyface': True, 'oval': False, 'overheadheight': 3, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 27,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'cert', 'copys': 4, 'faceheight': 9, 'gray_frame': False, 'height': 34,
             'name': 'Ветеран войны', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 27,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'cert', 'copys': 4, 'faceheight': 9, 'gray_frame': False, 'height': 34,
             'name': 'Мать одиночка', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 27,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'cert', 'copys': 4, 'faceheight': 7, 'gray_frame': False, 'height': 25,
             'name': 'Профсоюзный билет', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 25,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 12, 'gray_frame': False, 'height': 45,
             'name': 'Вид на жительство', 'onlyface': False, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 35, 'gray_frame': False, 'height': 50,
             'name': 'Грин-карта', 'onlyface': False, 'oval': False, 'overheadheight': 5, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 50,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 1, 'faceheight': 50, 'gray_frame': False, 'height': 120,
             'name': 'Личное дело', 'onlyface': False, 'oval': False, 'overheadheight': 7, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 90,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 15, 'gray_frame': False, 'height': 55,
             'name': 'Пропуск', 'onlyface': True, 'oval': False, 'overheadheight': 6, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 40,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 6, 'faceheight': 12, 'gray_frame': False, 'height': 40,
             'name': 'Формат (30 х 40)', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 30,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 15, 'gray_frame': False, 'height': 45,
             'name': 'Формат (35 x 45)', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 35,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 12, 'gray_frame': False, 'height': 50,
             'name': 'Формат (40 x 50)', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 40,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 15, 'gray_frame': False, 'height': 60,
             'name': 'Формат (40 x 60)', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 40,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 12, 'gray_frame': False, 'height': 35,
             'name': 'Формат (45 x 35)', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 45,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 14, 'gray_frame': False, 'height': 50,
             'name': 'Формат (45 x 50)', 'onlyface': True, 'oval': False, 'overheadheight': 4, 'paper': '10x15',
             'print_photo': False, 'to_grayscale': False, 'width': 45,
             'url': 'http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin'},
            {'angle': False, 'category': 'other', 'copys': 4, 'faceheight': 22, 'gray_frame': False, 'height': 60,
    ...
    def about(self, widget, data=None):
        ...
        about_dialog.set_version('от 01.06.2016')
        about_dialog.set_copyright('Авторские права © 2012-2016\nАлександр Карабанов (zend.karabanov@gmail.com)')
    ...
    def create_id_foto(self, image, drawable, format, auto_levels):
        ...
        dguide_list = []
        # Находим направляющие, узнаем их тип (вертикальная/горизонтальная)
    ...
    # Эта функция конвертирует цветное изображение в чёрно-белое (с оттенками серого)
    ...
    def oval(self, image, drawable):
        ...
        white_oval = gimp.Layer(image, 'Овал с растушёвкой', drawable.width, drawable.height, RGBA_IMAGE, 100,
                                NORMAL_MODE)
        # Запоминаем цвет фона
        old_background = gimp.get_background()
        ...
        pdb.gimp_image_select_ellipse(image, CHANNEL_OP_REPLACE, (drawable.width * 0.1), 0, (drawable.width * 0.8),
                                      (drawable.height * 0.9))
    ...
    def angle(self, image, drawable, type):
        if type == 'right_circular':
            ...
            pdb.gimp_image_select_ellipse(image, CHANNEL_OP_REPLACE,
                                          (image.width - self.mm_in_px(18, shelf['format']['resolution'])),
                                          (image.height - self.mm_in_px(14, shelf['format']['resolution'])),
                                          self.mm_in_px(45, shelf['format']['resolution']),
                                          self.mm_in_px(45, shelf['format']['resolution']))
            ...
            # Задаём радиус растушёвки краёв
            pdb.gimp_context_set_feather_radius(2.0, 2.0)
            pdb.gimp_image_select_ellipse(image, CHANNEL_OP_REPLACE, -self.mm_in_px(26, shelf['format']['resolution']),
                                          (image.height - self.mm_in_px(14, shelf['format']['resolution'])),
                                          self.mm_in_px(45, shelf['format']['resolution']),
                                          self.mm_in_px(45, shelf['format']['resolution']))
            ...
            # Задаём радиус растушёвки краёв
            pdb.gimp_context_set_feather_radius(2.0, 2.0)
            points = [image.width, (image.height - self.mm_in_px(14, shelf['format']['resolution'])), image.width,
                      image.height, (image.width - self.mm_in_px(16, shelf['format']['resolution'])), image.height]
            ...
            # Задаём радиус растушёвки краёв
            pdb.gimp_context_set_feather_radius(2.0, 2.0)
            points = [0, (image.height - self.mm_in_px(14, shelf['format']['resolution'])), 0, image.height,
                      self.mm_in_px(16, shelf['format']['resolution']), image.height]
            pdb.gimp_image_select_polygon(image, CHANNEL_OP_REPLACE, 6, points)
        # Запоминаем цвет фона
        old_background = gimp.get_background()
        # Меняем цвет фона на белый
    ...
    def print_functon(self, image, drawable, paper, copys, print_photo):
        ...
        # Проверяем стоит ли вообще заморачиваться с печатью
        if w_count == 0 or h_count == 0:
            self.info('Ни одной фотографии не помещается на выбранном вами листе бумаги формата "' + str(
        ...
        # Позиционируем слой источник в точку отсчета, в этакое начало координат
        drawable.translate(x_fundamental, y_fundamental)
        # Инициируем счетчик, который будет отсчитывать текущее количество фотографий на холсте
        ...
        for i in range(h_count):
            for j in range(w_count):
                ...
                # Если пользователь хочет напечатать меньше фоток чем может поместиться на холсте,
        ...
        for format_id in self.format_radio:
            if format_id.get_active():
                ...
                if data == 'auto_execute':
                    # Меняем размеры
                    self.image.scale(self.mm_in_px(shelf['format']['width'], shelf['format']['resolution']),
                                     self.mm_in_px(shelf['format']['height'], shelf['format']['resolution']))
                    if self.data['formats'][self.format_radio.index(format_id)]['angle']:
                        self.angle(self.image, self.drawable,
                                   self.data['formats'][self.format_radio.index(format_id)]['angle'])
    ...
    # Эта функция не только формирует конечный результат
    ...
    def apply_settings(self, widget, data=None):
        ...
        if self.save_model_check.get_active():
            self.data['properties']['save_model'] = True
        else:
            self.data['properties']['save_model'] = False
    ...
    def edit_format(self, widget, data=None):
        ...
        for format_id in self.format_radio:
            if format_id.get_active():
                ...
                self.width_adj = gtk.Adjustment(self.data['formats'][self.format_radio.index(format_id)]['width'], 0.0,
                                                200.0, 1.0, 1.0, 0.0)
                ...
                self.height_adj = gtk.Adjustment(self.data['formats'][self.format_radio.index(format_id)]['height'],
                ...
                self.overheadheight_adj = gtk.Adjustment(
                    self.data['formats'][self.format_radio.index(format_id)]['overheadheight'], 0.0, 200.0, 1.0, 1.0,
                    0.0)
                ...
                # Количество фоток
                self.copys_adj = gtk.Adjustment(self.data['formats'][self.format_radio.index(format_id)]['copys'], 1.0,
                                                200.0, 1.0, 1.0, 0.0)
                ...
                self.faceheight_adj = gtk.Adjustment(
                    self.data['formats'][self.format_radio.index(format_id)]['faceheight'], 0.0, 200.0, 1.0, 1.0, 0.0)
                ...
                dialog = gtk.Dialog(
                    'Правка формата "' + self.data['formats'][self.format_radio.index(format_id)]['name'] + '"',
                    self.window, gtk.DIALOG_NO_SEPARATOR | gtk.DIALOG_MODAL | gtk.DIALOG_DESTROY_WITH_PARENT,
                ...
                if response == gtk.RESPONSE_OK:
                    ...
                    pickle.dump(self.data, config)
                    config.close()
                    self.format_radio[self.format_radio.index(format_id)].set_name(
                        str(self.data['formats'][self.format_radio.index(format_id)]['name']))
                    self.add_success_label.set_markup('<span foreground="#008600">"' + str(
                        self.data['formats'][self.format_radio.index(format_id)][
                            'name']) + '" успешно изменён\n</span>')
                    dialog.hide()
                    dialog.destroy()
                break
    ...
    def delete_format(self, widget, data=None):
        ...
        for format_id in self.format_radio:
            if format_id.get_active():
                ...
                dialog = gtk.Dialog(
                    'Удаление формата "' + self.data['formats'][self.format_radio.index(format_id)]['name'] + '"',
                    self.window, gtk.DIALOG_NO_SEPARATOR | gtk.DIALOG_MODAL | gtk.DIALOG_DESTROY_WITH_PARENT,
                    (gtk.STOCK_NO, gtk.RESPONSE_CANCEL, gtk.STOCK_YES, gtk.RESPONSE_OK))
                dialog.set_position(gtk.WIN_POS_CENTER_ALWAYS)
                dialog.set_resizable(False)
                dialog.set_border_width(10)
                self.confirmation_label = gtk.Label('Вы действительно хотите удалить формат "' +
                                                    self.data['formats'][self.format_radio.index(format_id)][
                                                        'name'] + '"?')
    ...
    def add_format(self, widget, data=None):
        ...
        self.table.show()
        # Инициируем диалог, на котором будут все наши виджеты находиться
        dialog = gtk.Dialog('Добавить новый формат', self.window,
                            gtk.DIALOG_NO_SEPARATOR | gtk.DIALOG_MODAL | gtk.DIALOG_DESTROY_WITH_PARENT,
        ...
        if response == gtk.RESPONSE_OK:
            ...
            self.add_success_label.set_markup(
                '<span foreground="#008600">"' + str(name) + '" успешно добавлен\n</span>')
            dialog.hide()
            dialog.destroy()
...
class select_format_id_photo(id_photo_base):
    def __init__(self, runmode, image, drawable):
        ...
        self.learn_more_label.set_markup(
            '<a href="http://gimp-id-photo.ru/formats_data/sorry_no_data.html?from=plugin">Узнать подробности о формате "Паспорт РФ"</a>')
        self.learn_more_label.set_tooltip_text(
            'Поросмотреть сведения о формате с помощью браузера используемого по умолчанию')
        ...
        self.cancel_button = gtk.Button('Отмена', None, gtk.STOCK_CANCEL)
        ...
        self.apply_button = gtk.Button('Применить', None, gtk.STOCK_APPLY)
...
class settings(id_photo_base):
    def __init__(self, runmode, image):
        ...
        self.add_button = gtk.Button('Добавить', None, gtk.STOCK_ADD)
        ...
        self.edit_button = gtk.Button('Правка', None, gtk.STOCK_EDIT)
        ...
        self.delete_button = gtk.Button('Удалить', None, gtk.STOCK_DELETE)
        ...
        self.formats_table.attach(self.add_success_label, 0, 1, 1, 2, gtk.FILL | gtk.SHRINK, gtk.FILL | gtk.SHRINK, 0,
                                  0)
        self.formats_table.attach(self.button_format_hbox, 0, 1, 2, 3, gtk.FILL | gtk.SHRINK, gtk.FILL | gtk.SHRINK, 0,
                                  0)
        ...
        self.ppi_label.show()
        # Делаем активным пункт выпадающего списка разрешений
        ...
        self.ppi_hbox.show()
        # Создаем флажок 'Добавлять слой "Белый фон"'
        self.white_bg_check = gtk.CheckButton('Добавлять слой "Белый фон"')
        ...
        # Создаем флажок 'Использовать авто-уровни'
        self.auto_levels_check = gtk.CheckButton('Использовать "авто-уровни"')
        ...
        # Создаём флажок 'Сохранять макет'
        self.save_model_check = gtk.CheckButton('Сохранять макет (.jpg)')
        self.save_model_check.set_tooltip_text('Автоматическое сохранение созданного макета в директории с оригинальным файлом (формат JPEG')
        self.save_model_check.show()
        if self.data['properties']['save_model']:
            self.save_model_check.set_active(True)
       
        # Создаём метку в которую будем выводить сообщения
        self.success_label = gtk.Label(None)
        self.success_label.set_markup(
            '<span foreground="#008600"><a href="http://gimp-id-photo.ru">Успешно сохранено</a></span>');
        ...
        self.different_options_vbox.pack_start(self.save_model_check, False, False, 0)
        ...
        self.about_button = gtk.Button('О программе', None, gtk.STOCK_ABOUT)
...
class print_photo(id_photo_base):
    def __init__(self, runmode, image, drawable):
        ...
        self.print_button = gtk.Button('Печать', None, gtk.STOCK_PRINT)
...
class id_photo_plugin(gimpplugin.plugin):
    ...
    def query(self):
        ...
        imgmenupath = '<Image>/Фото на документы/'
        date = '2012-2016'

        select_format_id_photo_description = 'Выбор формата.'
        ...
        settings_description = 'Настройки дополнения.'
        ...
        print_photo_description = 'Формирование и печать макета.'
